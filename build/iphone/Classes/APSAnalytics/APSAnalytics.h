 ...
 * to send analytic data that can be viewed on the PushNotifications Dashboard.
 *
 * For information on getting started with PushNotifications Platform Services,
