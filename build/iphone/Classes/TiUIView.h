...
/**
 Base class for all PushNotifications views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PushNotifications view hierarchy (such as wrapped iOS UIViews) was touched.
