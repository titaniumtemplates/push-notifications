...
// in simulator we redefine to format for PushNotifications Developer console
...
{\
	NSString * exceptionName = [@"org.pushnotifications." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pushnotifications";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPushNotificationsNativeItemNone = -1, 
	UIPushNotificationsNativeItemSpinner = -2,
	UIPushNotificationsNativeItemProgressBar = -3,
	
	UIPushNotificationsNativeItemSlider = -4,
	UIPushNotificationsNativeItemSwitch = -5,
	UIPushNotificationsNativeItemMultiButton = -6,
	UIPushNotificationsNativeItemSegmented = -7,
	
	UIPushNotificationsNativeItemTextView = -8,
	UIPushNotificationsNativeItemTextField = -9,
	UIPushNotificationsNativeItemSearchBar = -10,
	
	UIPushNotificationsNativeItemPicker = -11,
	UIPushNotificationsNativeItemDatePicker = -12,
	
	UIPushNotificationsNativeItemInfoLight = -13,
	UIPushNotificationsNativeItemInfoDark = -14,
	
	UIPushNotificationsNativeItemDisclosure = -15,
	
	UIPushNotificationsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PushNotifications instances of
