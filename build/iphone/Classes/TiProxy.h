...
//Rare exceptions to indicate a bug in the _pushnotifications code (Eg, function that a subclass should have implemented)
...
/**
 The base class for PushNotifications proxies.
 */
