...
@interface PushNotificationsObject : KrollCoverageObject {
#else
@interface PushNotificationsObject : KrollObject {
#endif
@private
...
extern NSString * PushNotifications$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PushNotificationsObject *_pushnotifications;
    KrollObject* console;
	BOOL shutdown;
