...
//@interface PushNotificationsObject : NSObject
//@end

@interface PushNotificationsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PushNotificationsObject class]])
		{
			for (NSString *key in [[(PushNotificationsObject*)o modules] allKeys])
			{
